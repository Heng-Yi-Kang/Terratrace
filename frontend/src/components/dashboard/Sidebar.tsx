      ...
      <div className="p-4 border-t border-cyan-primary/30">
        <div className="flex items-center gap-3 px-3 py-3">
          <div className="w-10 h-10 rounded-full bg-cta flex items-center justify-center">
            <span className="font-sans font-semibold text-cyan-primary">EU</span>
          </div>
          <div>
            <p className="font-sans font-medium text-sm text-white">Eco Traveler</p>
            <p className="font-sans text-xs text-white/60">Free Plan</p>
          </div>
        </div>
      </div>
    </aside>
