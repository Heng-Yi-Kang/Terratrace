...
type TripStatus = 'upcoming' | 'completed' | 'all'
type EcoScoreFilter = 'all' | 'high' | 'medium'
          ...
          {filteredTrips.map((trip) => (
            ...
            >
              <div className={`h-32 ${trip.imageColor} relative`}>
                ...
                <div className="absolute top-3 right-3 px-3 py-1 rounded-full bg-white/90 text-xs font-sans font-semibold text-text">
