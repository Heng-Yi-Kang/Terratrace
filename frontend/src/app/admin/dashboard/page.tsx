  ...
  const renderTab = () => {
    switch (activeTab) {
      ...
      case 'users':
        return (
          <div>
            <h1 className="font-heading font-bold text-3xl text-text mb-2">Users</h1>
            <p className="text-text/70">Manage user accounts and permissions</p>
          </div>
        )
      case 'destinations':
        return (
          <div>
            <h1 className="font-heading font-bold text-3xl text-text mb-2">Destinations</h1>
            <p className="text-text/70">Manage eco-certified destinations</p>
          </div>
        )
      case 'analytics':
        return (
          <div>
            <h1 className="font-heading font-bold text-3xl text-text mb-2">Analytics</h1>
            <p className="text-text/70">View platform usage statistics</p>
          </div>
        )
      default:
        return (
