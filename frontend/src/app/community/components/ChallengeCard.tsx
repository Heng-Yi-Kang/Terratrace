...
import { BoltIcon, FireIcon, StarIcon, ArrowRightIcon, LeafIcon } from './Icons';
  ...
  return (
    ...
    >
      ...
      <div className="mb-3.5 mt-2 flex items-start justify-between gap-3">
        ...
        <span className="text-xs text-emerald-900/60">⏱ {challenge.daysLeft} days left</span>
      </div>
      ...
      <div className="flex items-center justify-between border-t border-emerald-100 pt-4">
        ...
        <button className="inline-flex items-center gap-1.5 bg-transparent border-none text-emerald-600 py-1 font-semibold text-sm cursor-pointer transition-all duration-200 hover:gap-2.5">
          Continue
