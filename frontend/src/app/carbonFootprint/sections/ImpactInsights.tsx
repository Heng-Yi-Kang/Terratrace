  ...
  return (
    <section className=" relative overflow-hidden ">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
            <h2 className="text-2xl font-heading font-bold text-text mb-2">Impact Insights</h2>
            <p className="text-text/60">Understand the impact of your travel choices on the environment</p>
          </div>
          ...
          <div className="flex items-center justify-between gap-4 mb-6">
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-baseline">
                <p ref={totalRef} className="text-6xl font-bold text-text">{totalDisplay}</p>
                <p className="text-xl text-text font-bold ms-2">kg CO<sub>2</sub></p>
              </div>
            </div>

            <div ref={treesRef} className="bg-primary/20 rounded-organic p-4 text-center">
              <h3 className="font-semibold text-4xl text-text">{treesDisplay}</h3>
